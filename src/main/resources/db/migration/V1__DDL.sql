...
CREATE TABLE verification_token(id INTEGER generated by default as identity PRIMARY KEY, userId INTEGER, expiryDate DATE);
CREATE TABLE password_reset_token(id INTEGER generated by default as identity PRIMARY KEY, userId INTEGER, expiryDate DATE);