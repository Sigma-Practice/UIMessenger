...
CREATE TABLE verificationtoken(id INTEGER generated by default as identity PRIMARY KEY, token VARCHAR(200), userId INTEGER, expiryDate TIMESTAMP);
CREATE TABLE passwordresettoken(id INTEGER generated by default as identity PRIMARY KEY, token VARCHAR(200), userId INTEGER, expiryDate TIMESTAMP);